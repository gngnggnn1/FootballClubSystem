        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <% Team team = (Team)request.getAttribute("myTeam"); %>
                        <form method="get" class="form-horizontal">
							...
							<div class="form-group">
                                <label class="col-sm-2 control-label">球队等级</label>

                                <div class="col-sm-10">
                                    <% if(team.getTeamGrade() == 1){ %>
                                    	成年男足
                                    <% } %>
							...
							<div class="form-group">
                                <label class="col-sm-2 control-label">队长：</label>
